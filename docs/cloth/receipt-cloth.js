...
import { PAPER_PRESET, gridForViewport, isDebugPhysics, isClothTune } from './config.js?v=67';
import { createXPBDSolver } from './xpbd-solver.js?v=67';
import { captureReceiptTexture, measureUvRegions, hitUvRegion } from './texture-capture.js?v=60';
import { createClothSettingsPanel } from './cloth-settings.js?v=67';
