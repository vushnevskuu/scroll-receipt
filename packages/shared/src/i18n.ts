...
const messages = {
  ru: {
    ...
    onboardingAutoSchedule:
      'Часовой пояс определяется автоматически. Чек за вчера приходит в 18:00 по вашему локальному времени.',
  ...
  en: {
    ...
    onboardingAutoSchedule:
      'Timezone is detected automatically. Yesterday\'s receipt arrives at 18:00 local time.',
